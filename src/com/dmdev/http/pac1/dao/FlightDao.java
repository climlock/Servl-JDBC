...
import com.dmdev.http.pac1.entity.Flight;
import com.dmdev.http.pac1.entity.FlightStatus;
import com.dmdev.http.pac1.util.ConnectionManager;
...
public class FlightDao implements Dao<Long, Flight> {
    ...
    @Override
    public Optional<Flight> findById(Long di) {
